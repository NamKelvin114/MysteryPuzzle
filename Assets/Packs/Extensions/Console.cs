...
namespace Lance.Common
{
    ...
    {
        public const string ENABLE_LOG = "ENABLE_LOG"; // flag on of log
        public const string FORMAT_HEADER = "<color={0}[</color> {1} <color={0}]</color> ";

// #if UNITY_EDITOR
// #if ENABLE_LOG
//         [UnityEditor.MenuItem("Window/Lance/Utility/Disable Log")]
//         private static void DisableLog()
//         {
//             EditorUtility.EditorUtil.RemoveDefineSymbols(ENABLE_LOG);
//         }
// #else
//          [UnityEditor.MenuItem("Window/Lance/Utility/Enable Log")]
...
// #endif
        ...
        public static void Log(string header, string format, params object[] args)
        {
            UnityEngine.Debug.LogFormat(string.Format(FORMAT_HEADER, "#64E8FF", header) + format, args);
        }
        ...
        [Conditional(ENABLE_LOG)]
        public static void Log(string header, object message) { UnityEngine.Debug.Log(string.Format(FORMAT_HEADER, "#64E8FF", header) + message); }
        ...
        {
            UnityEngine.Debug.LogWarningFormat(string.Format(FORMAT_HEADER, "#FFD364", header) + format, args);
        }
        ...
        /// <param name="message">String or object to be converted to string representation for display.</param>
        [Conditional(ENABLE_LOG)]
        public static void Warning(string header, object message) { UnityEngine.Debug.LogWarning(string.Format(FORMAT_HEADER, "#FFD364", header) + message); }
        ...
        {
            UnityEngine.Debug.LogErrorFormat(string.Format(FORMAT_HEADER, "#FF6471", header) + format, args);
        }
        ...
        /// <param name="message">String or object to be converted to string representation for display.</param>
        [Conditional(ENABLE_LOG)]
        public static void Error(string header, object message) { UnityEngine.Debug.LogError(string.Format(FORMAT_HEADER, "#FF6471", header) + message); }
        ...
        {
            UnityEngine.Debug.LogException(new Exception(string.Format(FORMAT_HEADER, "#FF6471", header) + e.Message, e.InnerException));
        }
        ...
        [Conditional(ENABLE_LOG)]
        public static void DrawLine(UnityEngine.Vector3 start, UnityEngine.Vector3 end) { UnityEngine.Debug.DrawLine(start, end); }
        ...
        [Conditional(ENABLE_LOG)]
        public static void DrawLine(UnityEngine.Vector3 start, UnityEngine.Vector3 end, UnityEngine.Color color) { UnityEngine.Debug.DrawLine(start, end, color); }
        ...
        [Conditional(ENABLE_LOG)]
        public static void DrawRay(UnityEngine.Vector3 start, UnityEngine.Vector3 direction) { UnityEngine.Debug.DrawRay(start, direction); }
        ...
        {
            UnityEngine.Debug.DrawRay(start,
                direction,
                color,
                duration,
                depthTest);

...
namespace Lance.Common
{
    ...
    public class Random
    {
        ...
        /// <summary>
        /// Generates a random int over the range 0 to <paramref name="upperBound"/> -1, and not including <paramref name="upperBound"/>.
        /// </summary>
        ...
        /// <summary>
        /// Generates a random int over the range <paramref name="lowerBound"/> to <paramref name="upperBound"/> -1, and not including upperBound.
        /// <paramref name="upperBound"/> must be >= <paramref name="lowerBound"/>. lowerBound may be negative.
        /// </summary>
    ...
    public static class Rand
    {
        ...
        public static Random ThreadSafe
        {
            get
            {
                ...
                return local ??= new Random(unchecked(Environment.TickCount * 31 + System.Threading.Thread.CurrentThread.ManagedThreadId));
#else
                return local = local ?? new Random(unchecked(Environment.TickCount * 31 + System.Threading.Thread.CurrentThread.ManagedThreadId));
#endif
            }
        }
    }
